...
function SearchEmployement() {
    ...
    const moreDetailsNavigate = (id) => {
        const data1 = tableData.filter((data => { return (data.Id == id) }))
        navigate('/home/semoredetails', { state: data1 });
    }
                ...
                <div className='mx-8 pt-8 pb-5'>
                    <div>
                        <div className=' bg-white rounded-lg'>
                            <p className='p-3 text-red-900 font-bold text-4xl '>Employment Search</p>
                        </div>

                        <div className='grid lg:grid-cols-12'>
                            <div className='lg:lg:col-span-11 cursor-all-scroll mt-7'>
                                <InputField bgColor='bg-white' padding='py-2.5' placeholder='Search By Company' inputType='text'
                                    value={searchTableData}
                                    handleChange={handleChange}
                                />
                            </div>

                            <div className=' lg:mt-7 mt-2 text-center'>
                        ...
                        <div className='mt-5'>
                            ...
                            <div class=" overflow-x-auto shadow-md ">
                                <table class="w-full text-md text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    <thead class="text-md text-white uppercase bg-red-900">
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            mapData.slice(firstIndex, lastIndex).map(((item, index) => {
                                                return (
                                                    <tr class="bg-white border-b text-black dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                        ...
                                                        <td class="px-6 py-4 text-right">
                                                            <p onClick={() => moreDetailsNavigate(item.Id)} class="font-medium  text-blue-600 dark:text-blue-500 hover:underline cursor-pointer">More Details</p>
                                                        </td>
                                                    </tr>
                                                )
                                            }))
...
export default SearchEmployement
